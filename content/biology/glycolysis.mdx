...
<ReactionTable from="glucose" to="glucose-6-phosphate" reversible="true" enzyme="hexokinase" enzyme_b="glucose-6-phosphate" uses="ATP/ADP" inhibitors="glucose-6-phosphate"/>
